...
abstract class RoomExtension {
    ...
    RoomSchemaLocationMergeTask.MergeAssociations roomSchemaMergeLocations

    @Inject
    RoomExtension(ObjectFactory objectFactory) {
        schemaLocationDir = objectFactory.directoryProperty()
        roomSchemaMergeLocations = objectFactory.newInstance(RoomSchemaLocationMergeTask.MergeAssociations)
    }
